...
<div class="row">
    ...
    if (isset($_POST['submit']) || isset($_POST['search'])){
        ...
        $searchVar = "%" . $search_result . "%";
        $result = p_statement($query_string = "SELECT * FROM tbl_posts WHERE p_tags LIKE ?", $type = "s", $vars = [$searchVar]);
        $q_r_count = mysqli_num_rows($result);
    ...
    echo "<h2>Search in the sidebar</h2>";
}
